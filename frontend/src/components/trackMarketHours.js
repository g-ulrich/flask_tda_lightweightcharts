...
export const MarketHoursProgress = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            setHours({
                pre: data.obj.preMarket[0], reg: data.obj.regularMarket[0], post: data.obj.postMarket[0],
        ...
        <>
            {hours === null ? (
                ...
                <div role="status" class="animate-pulse">
                    ...
                    <div class="h-2.5 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[640px] mt-2.5 mx-auto"></div>
                    ...
                    <div className="grid grid-cols-12 gap-2">
                        <div className="col-span-4">
                            ...
                            <span>
                                ...
                                <i class="bi bi-cup-hot-fill"></i> Pre-Market</h3>
                        ...
                        <div className="col-span-4">
                            <span>
                                ...
                                <i class="bi bi-bank"></i> Regular-Market</h3>
                        ...
                        <div className="col-span-4">
                            <span >
                                <h3 className={`font-medium leading-tight text-right ${isMarketOpen(hours.post.start, hours.post.end) ? 'text-discordPurple': ''}`}>
                                    <i class="bi bi-sunset-fill"></i> After-Market</h3>
